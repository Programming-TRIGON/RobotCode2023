...
public class AutonomousConstants {
    ...
    public static final PathConstraints AUTONOMOUS_PATH_CONSTRAINS = new PathConstraints(3, 4);
    ...
    private static void configureEventMap() {
        ...
        EVENT_MAP.put(
                "close-collect", RobotContainer.GRIPPER.getHoldCommand().alongWith(RobotContainer.ARM.getGoToStateCommand(ArmConstants.ArmStates.CLOSED))
        );
    }
